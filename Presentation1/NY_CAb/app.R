...
ui <-  bootstrapPage(
  ...
  absolutePanel(top = 10, right = 10,
                sliderInput("range", "Dates",as.POSIXct(1477958400, origin="1970-01-01"), as.POSIXct(1480550400, origin="1970-01-01"),
...
server <- function(input, output) {
      ...
      output$map <-renderLeaflet({
        ...
        temp <- DAY_TAXI_DATA %>% filter((daystart %% 86400)+1 & tpep_pickup_datetime >= daystart & tpep_pickup_datetime < daystart+600 & PUlon == DOlon & PUlat == DOlat)
